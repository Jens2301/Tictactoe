...
{
    public partial class Baggrund : Form
    {
        public Baggrund()
        {
            InitializeComponent();
        ...
        public void checkForWinner()
        {
            for (int i=0; i<8; i++)
            {
                ...
                {
                    reset();
                    MessageBox.Show("0 har vundet!", "Vinderen er fundet", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                else if(combination.Equals("XXX"))
                {
                    reset();
                    MessageBox.Show("X har vundet!", "Vinderen er fundet", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
